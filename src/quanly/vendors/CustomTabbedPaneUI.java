	    ...
	    protected void paintTabBackground(Graphics g, int tabPlacement, int tabIndex, int x, int y, int w, int h, boolean isSelected) {
	        ...
	        switch (tabPlacement) {
	            case LEFT:
	                ...
	                gradientShadow = new GradientPaint(x, y, new Color(2, 132, 168), x, y + h, Color.ORANGE);
	                break;
	            case RIGHT:
	                xp = new int[]{x, x, x + w - 2, x + w - 2, x};
	                yp = new int[]{y, y + h - 3, y + h - 3, y, y};
	                gradientShadow = new GradientPaint(x, y, new Color(2, 132, 168), x, y + h, new Color(153, 186, 243));
	                break;
	            case BOTTOM:
	            ...
	            case TOP:
	            	 xp = new int[]{x, x, x + 3, x + w - inclTab - 6, x + w - inclTab - 2, x + w - inclTab, x + w - 3, x};
		                yp = new int[]{y - 3, y - 3 + h, y + h, y + h, y + h, y + h, y, y};
		                gradientShadow = new GradientPaint(x, y, new Color(2, 132, 68), x, y + h, new Color(255, 255, 255));
		                break;
	            default:
	                xp = new int[]{x, x, x + 3, x + w - inclTab - 6, x + w - inclTab - 2, x + w - inclTab, x + w - inclTab, x};
	                yp = new int[]{y + h, y + 3, y, y, y + 1, y + 3, y + h, y + h};
	                gradientShadow = new GradientPaint(0, 0, new Color(2, 132, 168), 0, y + h / 2, new Color(240, 255, 210));
	                break;
	        }
	        // ;
