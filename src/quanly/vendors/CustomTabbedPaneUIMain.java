...
public class CustomTabbedPaneUIMain extends BasicTabbedPaneUI {
...
//	}
	...
	protected void paintTabBackground(Graphics g, int tabPlacement, int tabIndex, int x, int y, int w, int h,
		...
		Color tabColor = new Color(51, 51, 51);
		...
		case LEFT:
			...
			//gradientShadow = new GradientPaint(x, y, new Color(2, 132, 68), x, y + h, new Color(167, 167, 167));
			break;
		case RIGHT:
			xp = new int[] { x, x, x + w - 2, x + w - 2, x };
			yp = new int[] { y, y + h - 3, y + h - 3, y, y };
			gradientShadow = new GradientPaint(x, y, new Color(51, 51, 51), x, y + h, new Color(153, 186, 243));
			break;
		case BOTTOM:
			xp = new int[] { x, x, x + 3, x + w - inclTab - 6, x + w - inclTab - 2, x + w - inclTab, x + w - 3, x };
			yp = new int[] { y, y + h - 3, y + h, y + h, y + h - 1, y + h - 3, y, y };
			gradientShadow = new GradientPaint(x, y, new Color(51, 51, 51), x, y + h, Color.BLUE);
			break;
		case TOP:
		default:
			...
			gradientShadow = new GradientPaint(0, 0, Color.ORANGE, 0, y + h / 2, new Color(2 ,132, 68));
			break;
		}
		// ;
		...
		if (isSelected) {
			...
			g2D.setPaint(tabColor);
		} else {
			if (tabPane.isEnabled() && tabPane.isEnabledAt(tabIndex)) {
				g2D.setColor(deSelectColor);
//				GradientPaint gradientShadowTmp = new GradientPaint(0, 0, new Color(255, 255, 200), 0, y + h / 2,
//						new Color(2 ,132, 68));
				Color painTmp = new Color(2, 132, 68);
				g2D.setPaint(painTmp);
			} else {
//				GradientPaint gradientShadowTmp = new GradientPaint(0, 0, new Color(2 ,132, 68), 0, y + 15 + h / 2,
//						new Color(204, 204, 204));
		...
		// deSelectColor = new Color(2 ,132, 68);
		g2D.fill(shape);
		if (runCount > 1) {
